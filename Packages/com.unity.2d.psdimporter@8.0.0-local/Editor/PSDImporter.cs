...
#pragma warning disable 169, 414
        ...
        void ImportFromLayers(AssetImportContext ctx, Document doc)
        {
            ...
            try
            {
                ...
                ImagePacker.Pack(layerBuffers.ToArray(), new int[] { doc.width }, new int[] { doc.height }, m_Padding, m_SpriteSizeExpand, out output, out width, out height, out spritedata, out uvTransform);
                var spriteImportData = GetSpriteImportData();
