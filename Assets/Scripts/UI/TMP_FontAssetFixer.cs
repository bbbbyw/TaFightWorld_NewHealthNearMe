...
namespace TMPro.EditorUtilities
{
    ...
    public static class TMP_EditorUtility
    {
        ...
        public static Material[] FindMaterialReferences(TMP_FontAsset fontAsset)
        {
            ...
            Material mat = GetSafeMaterial(fontAsset);

            if (mat == null)
            {
                Debug.LogError($"❌ Cannot find valid material for TMP_FontAsset '{fontAsset?.name}'. Skipping.");
                return refs.ToArray();
            }
        ...
        /// <summary>
        /// Returns a material safely. If the fontAsset or its material is missing,
        /// attempts to load a fallback TMP_FontAsset at a known path.
        /// </summary>
