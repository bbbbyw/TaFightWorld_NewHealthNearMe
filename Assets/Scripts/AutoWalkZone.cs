...
public class AutoWalkZone : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            currentSpeed = playerRb.linearVelocity.x;
        }
    }
    ...
    private IEnumerator SmoothExit()
    {
        ...
        while (t < 1f)
        {
            ...
            if (playerRb != null)
            {
                ...
                playerRb.linearVelocity = new Vector2(newSpeed, playerRb.linearVelocity.y);
            }
            yield return new WaitForFixedUpdate();
        }
    ...
    private void FixedUpdate()
    {
        ...
        // Apply movement
        playerRb.linearVelocity = new Vector2(currentSpeed, playerRb.linearVelocity.y);
    }
